#!/usr/bin/env python3
"""
List all .xsl, .yaml, .yml, .json, .wsdl and other non-script files in all resources directories of unzipped API bundles, with paths relative to APIGEE2KONGMIGRATIONTOOL.
"""
import os
